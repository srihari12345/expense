        ...
        value: function forgotPassword() {
          ...
          this._auth.forgotPassword(this.forgotForm.value).subscribe(function (response) {
            ...
            if (response.status == 200) {
              ...
              _this3.router.navigateByUrl('/authenticate');
            } else {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function signIn() {
          ...
          this._auth.signin(this.signInForm.value).subscribe(function (response) {
            ...
            if (response.status == 200) {
              _this6._auth.setUserInfoInLocalStorage(response.data.userDetails);

              _this6._auth.setAuthToken(response.data.authToken); //this._comm.emitChange(true);


              _this6.router.navigate(["/groups"]); //redirects

            } else {
              (function (error_message) {
                if (error_message.status == 404) {
                  _this6.toastr.warning("Login Failed");
                } else if (error_message.status == 400) {
                  _this6.toastr.warning("Login Failed", "Wrong Password");
                } else {
                  _this6.toastr.error("Some Error Occurred", "Error!");
                }
              });
            }
          });
          ...
          if (this.password != this.confirmPassword) {
            ...
            this._auth.updatePassword(data).subscribe(function (apiResponse) {
              if (apiResponse.status == 200) {
                _this7.toastr.success("Please login", "Password Updated!");

                setTimeout(function () {
                  _this7.goToSignIn();
                }, 1000); //redirecting to signIn page
              } else {
                _this7.toastr.error(apiResponse.message, "Error!");
              }
            }, function (error) {
              if (error.status == 404) {
                _this7.toastr.warning("Password Update failed", "Please request another password reset!");
              } else {
                _this7.toastr.error("Some Error Occurred", "Error!");
              }
    ...
    var SocketService = function SocketService(http) {
      ...
      this.verifyUser = function () {
        return rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"].create(function (observer) {
          _this8.socket.on('verifyUser', function (data) {
      ...
      this.onlineUserList = function () {
        return rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"].create(function (observer) {
          _this8.socket.on('online-user-list', function (userList) {
      ...
      this.disconnect = function () {
        return rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"].create(function (observer) {
          _this8.socket.on('disconnect', function () {
            observer.next();
          });
        });
      };
      ...
      this.listenAuthError = function () {
        return rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"].create(function (observer) {
          _this8.socket.on('auth-error', function (data) {
            observer.next(data);
          });
        });
      };
      ...
      this.getUpdatesFromUser = function (userId) {
        return rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"].create(function (observer) {
          _this8.socket.on(userId, function (data) {
            observer.next(data);
          });
        });
      };
      ...
      this.receiveSocketNotification = function () {
        return rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"].create(function (observer) {
          _this8.socket.on('receive-notification', function (data) {
      ...
      this.notifyUpdates = function (data) {
        _this8.socket.emit('notify-updates', data);
      };

      this.notifyUpdatesItem = function (data) {
        _this8.socket.emit('notify-updates-item', data);
      };
      ...
      this.disconnectedSocket = function () {
        _this8.socket.emit("disconnect", "");
      };

      this.sendSocketNotification = function (data) {
        console.log("send notification", data);

        _this8.socket.emit('send-notification', data);
      };
    ...
    function () {
      function AddExpenseComponent(fb, _groups, toastr, _router, _authenticate, _utils, route, _socket) {
        ...
        this.getGroupDetails = function (gid) {
          _this9._groups.groupDetails(gid).subscribe(function (response) {
            console.log(response);

            if (response.error == true && response.status == 404) {
              console.log("in if");

              _this9.toastr.warning(response.message, "");
            } else if (response.status == 200 && response.data) {
              console.log("in else if");
              _this9.groupDetail = response.data;
              _this9.allUsers = _this9.groupDetail.group_users;
              console.log(_this9.allUsers);
            }
          }, function (error) {
            console.log(error);
          });
        ...
        this.resetForm = function () {
          ...
          _this9._router.navigateByUrl("/groups");
        };
      }
        ...
        value: function createExpense() {
          ...
          this._groups.createExpense(req).subscribe(function (response) {
            ...
            if (response.status == 200 && response.data) {
              _this11.addExpenseForm.reset();

              _this11._socket.sendSocketNotification(req.expenseUsersInvolved);

              _this11._router.navigate(["/groups", _this11.groupId]);
            }
  ...
  function srcAppModulesExpensesUpdateExpenseUpdateExpenseComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function UpdateExpenseComponent(fb, _groups, toastr, _router, _authenticate, _utils, route) {
        ...
        this.getGroupDetails = function (gid) {
          _this12._groups.groupDetails(gid).subscribe(function (response) {
            console.log(response);

            if (response.error == true && response.status == 404) {
              console.log("in if");

              _this12.toastr.warning(response.message, "");
            } else if (response.status == 200 && response.data) {
              console.log("in else if");
              _this12.groupDetail = response.data;
              _this12.allUsers = _this12.groupDetail.group_users;
              console.log(_this12.allUsers);
            }
          }, function (error) {
            console.log(error);
          });
        ...
        this.getExpenseDetails = function () {
          _this12._groups.expenseDetails(_this12.gid).subscribe(function (response) {
            console.log(response);
            ...
            if (response.error == true && response.status == 404) {
              ...
              console.log("in else if");
              _this12.expenseDetail = response.data;
      ...
      _createClass(UpdateExpenseComponent, [{
        ...
        value: function updateExpense() {
          ...
          this._groups.updateExpense(req).subscribe(function (response) {
            ...
            if (response.status == 200 && response.data) {
              setTimeout(function () {
                _this14.updateExpenseForm.reset();

                _this14._router.navigateByUrl("/groups");
              }, 1000);
            }
    ...
    function () {
      function CreateGroupComponent(_groups, toastr, fb, _router, _authenticate) {
        ...
        this.getMyGroups = function () {
          _this15._groups.getAllGroups(_this15.userId.userId, _this15.authToken).subscribe(function (response) {
            console.log(response);

            if (response.error == true && response.status == 404) {
              _this15.toastr.warning(response.message, "");
            } else if (response.status == 200 && response.data.length > 0) {
              _this15.allGroups = response.data;
            }
          }, function (error) {
            console.log(error);
          });
        ...
        this.getUsersGroup = function () {
          _this15._authenticate.getUsers(_this15.authToken).subscribe(function (response) {
            console.log(response);
        ...
        this.createGroup = function () {
          ...
          _this15.createGroupForm.value.group_users.push({
            item_id: _this15.userId.userId,
            item_text: _this15.userId.firstName + " " + _this15.userId.lastName
          });

          _this15.createGroupForm.patchValue({
            group_creatorName: _this15.userId.firstName + " " + _this15.userId.lastName,
            group_creatorId: _this15.userId.userId,
            group_updater_id: _this15.userId.userId,
            group_updater_name: _this15.userId.firstName + " " + _this15.userId.lastName
          });

          _this15._groups.addGroup(_this15.createGroupForm.value).subscribe(function (response) {
            console.log(response);

            if (response.status == 200 && response.data) {
              setTimeout(function () {
                _this15.createGroupForm.reset();

                _this15._router.navigateByUrl("/groups");
              }, 1000);

              _this15.getMyGroups();

              _this15.getUsersGroup();
            }
    ...
    function () {
      function GroupDetailsComponent(_authenticate, toastr, _groups, _router, fb, route, socket) {
        ...
        this.getAllUsers = function () {
          _this16._authenticate.getUsers(_this16.authToken).subscribe(function (response) {
            console.log(response);
        ...
        this.getExpenseDetails = function () {
          _this16._groups.expenseDetails(_this16.gid).subscribe(function (response) {
            console.log(response);
            ...
            if (response.error == true && response.status == 404) {
              ...
              console.log("in else if");
              _this16.expenseDetail = response.data;
              console.log(response.data);

              _this16.generateSettleExpenseData(_this16.expenseDetail);
            }
          }, function (error) {
            console.log(error);
          });
        ...
        this.generateSettleExpenseData = function (data) {
          _this16.settleExpenseTableData = [];
          ...
          if (data.length > 0) {
            data.forEach(function (element) {
              ...
              _this16.settleExpenseTableData.push({
                toPayToCreator: usersVal + " has to pay to " + element.expensePaidBy[0].item_text + " INR " + element.amount + " only"
              });
            });
            console.log(_this16.settleExpenseTableData);
          }
        };

        this.deleteExpense = function (id) {
          _this16._groups.deleteExpense(id).subscribe(function (res) {
            _this16.getExpenseDetails(_this16.gid);
          });
        };

        this.redirectToCreateExpense = function () {
          _this16._router.navigate(['/groups/expense/create-expense', _this16.gid]);
        };

        this.redirectToUpdateExpense = function () {
          _this16._router.navigate(['/groups/expense/update-expense', _this16.gid]);
        };

        this.getUpdatesFromUser = function () {
          _this16.socket.getUpdatesFromUser(_this16.userId).subscribe(function (data) {
            //getting message from user.
            _this16.toastr.info(data.message); //console.log(data)


            if (!data.gid) _this16.getExpenseDetails();
          });
        ...
        this.verifyUserConfirmation = function () {
          _this16.socket.verifyUser().subscribe(function () {
            _this16.socket.setUser(_this16.authToken); //in reply to verify user emitting set-user event with authToken as parameter.

          }, function (err) {
            _this16.toastr.error(err, "Some error occured");
          }); //end subscribe
        ...
        this.notifyUpdatesToUser = function (data) {
          ...
          _this16.socket.notifyUpdates(data); //console.log(data)


          if (!data.gid) _this16.getExpenseDetails(_this16.userId);
  ...
  function srcAppModulesGroupsGroupsGroupsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function GroupsComponent(_authenticate, toastr, _groups, _router, socket) {
        ...
        this.getMyGroups = function () {
          _this18._groups.getAllGroups(_this18.userId.userId, _this18.authToken).subscribe(function (response) {
            console.log(response);

            if (response.error == true && response.status == 404) {
              _this18.toastr.warning(response.message, "");
            } else if (response.status == 200 && response.data.length > 0) {
              _this18.allGroups = response.data;
            }
          }, function (error) {
            console.log(error);
          });
        ...
        this.deleteGroup = function (id) {
          _this18._groups.deleteGroup(id).subscribe(function (res) {
            console.log(res);
        ...
        this.groupDetails = function (id) {
          _this18._groups.groupDetails(id).subscribe(function (res) {
            console.log(res);

            _this18._router.navigate(["./groups/" + id]);
      ...
      function TopNavigationComponent(_comm, _auth, router, toastr, socket) {
        ...
        this.socket.receiveSocketNotification().subscribe(function (resp) {
          ...
          resp.forEach(function (element) {
            if (element.item_id == _this19.userId) {
      ...
      _createClass(TopNavigationComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.socket.receiveSocketNotification().subscribe(function (resp) {
            ...
            console.log("socket resposne received", resp);
            resp.forEach(function (element) {
              if (element.item_id == _this20.userId) {
                console.log("this is the user who receives notification", element);
                _this20.notificationCount++;
              }
            });
          });
          console.log("notification count", this.notificationCount);
