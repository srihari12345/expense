...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _modules_notifications_notifications_notifications_notifications_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    var _helpers_guards_auth_guard__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./helpers/guards/auth.guard */
    "./src/app/helpers/guards/auth.guard.ts");
    /* harmony import */


    var _page_not_found_page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./page-not-found/page-not-found/page-not-found.component */
    "./src/app/page-not-found/page-not-found/page-not-found.component.ts");
    /* harmony import */


    var _modules_groups_create_group_create_group_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./modules/groups/create-group/create-group.component */
    "./src/app/modules/groups/create-group/create-group.component.ts");
    /* harmony import */


    var _modules_groups_group_details_group_details_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./modules/groups/group-details/group-details.component */
    "./src/app/modules/groups/group-details/group-details.component.ts");
    /* harmony import */


    var _modules_expenses_add_expense_add_expense_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./modules/expenses/add-expense/add-expense.component */
    "./src/app/modules/expenses/add-expense/add-expense.component.ts");
    /* harmony import */


    var _modules_expenses_update_expense_update_expense_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
  ...
  function srcAppModulesGroupsModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _notifications_notifications_notifications_notifications_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./notifications/notifications/notifications/notifications.component */
    "./src/app/modules/notifications/notifications/notifications/notifications.component.ts");
    /* harmony import */


    var _expenses_add_expense_add_expense_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./expenses/add-expense/add-expense.component */
    "./src/app/modules/expenses/add-expense/add-expense.component.ts");
    /* harmony import */


    var _expenses_update_expense_update_expense_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](GroupsModule, {
        declarations: [_groups_groups_groups_component__WEBPACK_IMPORTED_MODULE_7__["GroupsComponent"], _groups_create_group_create_group_component__WEBPACK_IMPORTED_MODULE_5__["CreateGroupComponent"], _groups_group_details_group_details_component__WEBPACK_IMPORTED_MODULE_6__["GroupDetailsComponent"], _shared_top_navigation_top_navigation_top_navigation_component__WEBPACK_IMPORTED_MODULE_8__["TopNavigationComponent"], _notifications_notifications_notifications_notifications_component__WEBPACK_IMPORTED_MODULE_9__["NotificationsComponent"], _expenses_add_expense_add_expense_component__WEBPACK_IMPORTED_MODULE_10__["AddExpenseComponent"], _expenses_update_expense_update_expense_component__WEBPACK_IMPORTED_MODULE_11__["UpdateExpenseComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppModulesGroupsCreateGroupCreateGroupComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function CreateGroupComponent(_groups, toastr, fb, _router, _authenticate, _socket) {
        var _this13 = this;
        ...
        this.createGroup = function () {
          ...
          _this13._groups.addGroup(_this13.createGroupForm.value).subscribe(function (response) {
            ...
            if (response.status == 200 && response.data) {
              ...
              var userIds = [];
              response.data.group_users.forEach(function (element) {
                userIds.push(element.item_id);
              });

              _this13._socket.sendSocketNotifs('create-group-notification', {
    ...
    function GroupDetailsComponent_div_20_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function GroupDetailsComponent_div_20_Template_button_click_5_listener() {
          ...
          return ctx_r39.redirectToUpdateExpense();
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function GroupDetailsComponent_div_20_Template_button_click_18_listener() {
          ...
          return ctx_r41.deleteExpense(item_r37.expenseId);
        });
  ...
  function srcAppModulesGroupsGroupsGroupsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function GroupsComponent_div_8_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function GroupsComponent_div_8_Template_button_click_16_listener() {
          ...
          return ctx_r25.deleteGroup(group_r21);
        });
    ...
    /*#__PURE__*/
    function () {
      function GroupsComponent(_authenticate, toastr, _groups, _router, _socket, route) {
        var _this16 = this;
        ...
        this.getGroupDetails = function (gid) {
          _this16._groups.groupDetails(gid).subscribe(function (response) {
            console.log(response);
            ...
            if (response.error == true && response.status == 404) {
              ...
              console.log("in else if");
              _this16.groupDetail = response.data;
              console.log(response.data);
            }
          }, function (error) {
            console.log(error);
        ...
        this.deleteGroup = function (group) {
          _this16._groups.deleteGroup(group).subscribe(function (response) {
            if (response.status == 200 && response.data) {
              console.log(response);
              var userIds = [];
              response.data.group_users.forEach(function (element) {
              ...
              _this16._socket.sendSocketNotifs('create-group-notification', {
                group_name: response.data.group_name,
                group_users: userIds,
                groupId: response.data.groupId
              });
  ...
  function srcAppModulesNotificationsNotificationsNotificationsNotificationsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_helpers_services_notifications_notifications_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/helpers/services/notifications/notifications.service */
    "./src/app/helpers/services/notifications/notifications.service.ts");
    /* harmony import */
    ...
    var _shared_top_navigation_top_navigation_top_navigation_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../../../shared/top-navigation/top-navigation/top-navigation.component */
    "./src/app/modules/shared/top-navigation/top-navigation/top-navigation.component.ts");
    /* harmony import */
    ...
    function NotificationsComponent_div_9_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NotificationsComponent_div_9_Template_button_click_7_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r30);

          var notification_r28 = ctx.$implicit;

          var ctx_r29 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r29.MarkNotificationSeen(notification_r28.notifyId);
        });
    ...
    function NotificationsComponent_div_14_Template(rf, ctx) {
      ...
      if (rf & 2) {
        var notification_r31 = ctx.$implicit;
    ...
    /*#__PURE__*/
    function () {
      function NotificationsComponent(_router, _notification, _authenticate) {
        var _this18 = this;
        ...
        this.getNotificationsById = function () {
          _this18._notification.fetchNotificationById(_this18.userId.userId).subscribe(function (resp) {
            _this18.allNotifications = [];
            _this18.unreadNotifications = [];

            if (resp.message == 'Notifications Found' && resp.status == 200 && resp.data.length > 0) {
              _this18.allNotifications = resp.data;
              resp.data.forEach(function (element, index) {
                if (!element.isSeen) {
                  _this18.unreadNotifications.push(element);
                }
              });
            }
          });
        ...
        this.Notifications = function () {
          _this18.getNotificationsById();
        };

        this.MarkNotificationSeen = function (id) {
          _this18._notification.updateNotification(id).subscribe(function (resp) {
            console.log(resp);
    ...
    NotificationsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 15,
      vars: 2,
      consts: [[1, "container-fluid", "MT50"], [1, "row"], [1, "col-12"], ["mat-stretch-tabs", "", 1, "example-stretched-tabs", "mat-elevation-z4"], ["label", "Unread Notifications", 3, "click"], [1, "container-fluid", "MTB15"], ["class", "card MTB15", 3, "ngStyle", 4, "ngFor", "ngForOf"], ["label", "All Notifications", 3, "click"], [1, "card", "MTB15", 3, "ngStyle"], [1, "card-body"], [1, "col-8"], [1, "col-4"], ["mat-raised-button", "", "color", "primary", 1, "float-right", 3, "click"], [1, "material-icons"]],
      template: function NotificationsComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NotificationsComponent_Template_mat_tab_click_5_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NotificationsComponent_Template_mat_tab_click_10_listener() {
            return ctx.Notifications();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NotificationsComponent, [{
        ...
        return [{
          ...
          type: src_app_helpers_services_notifications_notifications_service__WEBPACK_IMPORTED_MODULE_2__["NotificationsService"]
        }, {
          type: src_app_helpers_services_authentication_authenticate_service__WEBPACK_IMPORTED_MODULE_3__["AuthenticateService"]
        }];
      }, null);
  ...
  function srcAppModulesSharedTopNavigationTopNavigationTopNavigationComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_helpers_services_notifications_notifications_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! src/app/helpers/services/notifications/notifications.service */
    "./src/app/helpers/services/notifications/notifications.service.ts");
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function TopNavigationComponent(_comm, _auth, router, toastr, socket, _notification) {
        var _this19 = this;
        ...
        this.getNotificationById = function () {
          _this19._notification.fetchNotificationById(_this19.userId).subscribe(function (resp) {
            if (resp.message == 'Notifications Found' && resp.status == 200 && resp.data.length > 0) {
              resp.data.forEach(function (element) {
                if (!element.isSeen) {
                  _this19.notificationCount++;
                }
              });
            }
          });
        ...
        this.logoutFunction = function () {
          _this19.authToken = _this19._auth.getUserAuth();

          _this19._auth.logout(_this19.userId, _this19.authToken).subscribe(function (response) {
            if (response.status === 200) {
              localStorage.removeItem("userInfo");
              localStorage.removeItem("auth");

              _this19._comm.emitChange(false);

              _this19.socket.disconnectedSocket();

              _this19.socket.exitSocket();

              _this19.router.navigate(["/authenticate"]);
            } else {
              _this19.toastr.error(response.message, "Error!");
            } // end condition

          }, function (err) {
            if (err.status == 404) {
              _this19.toastr.warning("Logout Failed", "Already Logged Out or Invalid User");

              _this19.router.navigate(["/authenticate"]);
            } else {
              _this19.toastr.error("Some Error Occurred", "Error!");
            }
          });
        };
        ...
        this.socket.receiveSocketNotification().subscribe(function (resp) {
          _this19.notificationCount = 0;

          _this19.getNotificationById(); // console.log("socket resposne received",resp);
          // if(resp.message == 'Notifications Found' && resp.status == 200 && resp.data.length > 0){
      ...
      _createClass(TopNavigationComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.socket.receiveSocketNotification().subscribe(function (resp) {
            _this20.notificationCount = 0;

            _this20.getNotificationById(); // console.log("socket resposne received",resp);
            // if(resp.message == 'Notifications Found' && resp.status == 200 && resp.data.length > 0){
            //   resp.data.forEach(element => {
            //     if(element.user.id == this.userId){
            //       this.notificationCount++;
    ...
    TopNavigationComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterLinkWithHref"], _angular_common__WEBPACK_IMPORTED_MODULE_7__["NgIf"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TopNavigationComponent, [{
        ...
        return [{
          ...
          type: src_app_helpers_services_notifications_notifications_service__WEBPACK_IMPORTED_MODULE_6__["NotificationsService"]
        }];
      }, {
        active: [{
