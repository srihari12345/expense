                    ...
                    let sendEmailOptions = {
                        ...
                        html: `<h4> Hi ${tokenDetails.userDetails.firstName}</h4>
                            <p>
                                ...
                                <br> <a href="http://localhost:4200/resetpassword/${options.validationToken}">Click Here</a>                                 
                            </p>
            ...
            UserModel.update({ 'userId': userDetails.userId }, options).exec((err, result) => {
                if (err) {
                    ...
                    let sendEmailOptions = {
                        ...
                        subject: 'Password Updated for split bills',
                        html: `<h4> Hi ${userDetails.firstName}</h4>
                        <p>
                            Password updated successfully.
                        </p>
                        <h3> Thanks for using split bills</h3>
                                    `
                    }
